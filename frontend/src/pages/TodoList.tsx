...
const TodoList = () => {
  ...
  }, [addTodoMutation, newTodoTitle, selectedTypeId]);
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="cursor-pointer bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 text-sm font-medium transition"
            >
              YouTube Search
            </button>
